    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Rumored'), (1, 'Planned'), (2, 'In production'), (3, 'Post production'), (4, 'Released'), (5, 'Cancelled')], default=-1, verbose_name='Status')),
