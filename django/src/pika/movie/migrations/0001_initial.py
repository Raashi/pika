# Generated by Django 2.2.3 on 2020-02-12 06:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote_average', models.DecimalField(decimal_places=2, max_digits=4, verbose_name='Vote average')),
                ...
                ('status', models.IntegerField(choices=[(0, 'Rumored'), (1, 'Planned'), (2, 'In production'), (3, 'Post production'), (4, 'Released'), (5, 'Cancelled')], verbose_name='Status')),
                ('poster', pika.db.fields.PosterImageField(blank=True, max_length=64, null=True, verbose_name='Poster')),
                ('backdrop', pika.db.fields.BackdropImageField(blank=True, max_length=64, null=True, verbose_name='Backdrop')),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movies', to='movie.Collection', verbose_name='Collection')),
                ('genres', models.ManyToManyField(related_name='movies', to='base.Genre', verbose_name='Genres')),
                ('keywords', models.ManyToManyField(related_name='movies', to='base.Keyword')),
                ...
                ('production_companies', models.ManyToManyField(related_name='movies', to='base.Company', verbose_name='Production companies')),
                ('production_countries', models.ManyToManyField(related_name='movies', to='db.Country', verbose_name='Production countries')),
                ('spoken_languages', models.ManyToManyField(related_name='in_movies', to='db.Language')),
            ],
            options={
                'verbose_name': 'Movie',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'Trailer'), (1, 'Teaser'), (2, 'Clip'), (3, 'Featurette'), (4, 'Behind the Scenes'), (5, 'Bloopers')], verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote_count', models.IntegerField(verbose_name='Vote count')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posters', to='movie.Movie')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote_average', models.IntegerField(verbose_name='Vote average')),
                ('vote_count', models.IntegerField(verbose_name='Vote count')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='backdrops', to='movie.Movie')),
            ],
            options={
                'verbose_name': 'Movie backdrop',
                'verbose_name_plural': 'Movie backdrops',
